...
class SOSearchKustosiTest {
	
	AbstractSO searchKustosi;
	String pretraga;
	...
	void setUp() throws Exception {
		searchKustosi = new SOSearchKustosi();
	}
	...
	@Test
	void testValidate() {
		assertThrows(Exception.class, () -> ((SOSearchKustosi)searchKustosi).validate(null));
		assertThrows(Exception.class, () -> ((SOSearchKustosi)searchKustosi).validate(new Eksponat()));
	}
	...
	void testExecute() {
		...
		List<Kustos> list = ((SOSearchKustosi)searchKustosi).getList();
